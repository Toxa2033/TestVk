...
public class WallMessage implements Serializable {
    ...
    public String text;
    public long id;
    public ArrayList<Atachment> attachments;
    ...
    public static WallMessage parse(JSONObject o) throws JSONException {
        ...
        wm.text = MainActivity.unescape(o.optString("text"));
        if (o.has("likes")){
        ...
        wm.attachments=Atachment.parseAttachments(attachments, wm.to_id, wm.copy_owner_id, geo_json);
        if (o.has("comments")){
        ...
        if (o.has("reposts")){
            JSONObject jlikes = o.getJSONObject("reposts");
    ...
    public static WallMessage parseForNotifications(JSONObject o) throws JSONException {
        ...
        wm.post_type = getPostType(o);
        wm.text = MainActivity.unescape(o.getString("text"));
